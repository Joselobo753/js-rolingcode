...
function eje2() {
  ...
  if (isNaN(nota)) {
    alert("ingrese una nota valida is nan");
...
function eje10() {
  alert(
    "Acontiacion se le pediran filas y columnas para crear una tabla con numeros decendetes"
  );
...
function eje12(){
  alert("su numero aleatorio entre 1 y 99 es "+ parseInt(Math.random(0,99)*100))
}
